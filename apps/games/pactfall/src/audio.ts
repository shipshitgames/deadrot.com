// Pactfall audio: the shared Deadrot engine with promoted shared samples plus
// the house fallback palette for cues that are still procedural. Music/SFX
// levels and mute follow the global settings store.
