...
export class AudioEngine {
  ...
  private trackForMode(mode: MusicMode): MusicTrack {
    return mode === "survivors" || mode === "multiplayer" ? "blood-circuit-ascension" : "ash-reactor";
  }
    ...
    switch (name) {
      ...
      case "levelup":
        [523, 698, 880, 1175].forEach((f, i) => {
          this.zap(t + i * 0.07, "triangle", f, f, 0.5, 0.24);
        });
      ...
      case "combo":
        [523, 659, 784].forEach((f, i) => {
          this.zap(t + i * 0.05, "triangle", f * p, f * p, 0.18, 0.18);
        });
        break;
      case "lowhealth":
      ...
      case "powerup":
        [440, 587, 740, 988].forEach((f, i) => {
          this.zap(t + i * 0.06, "triangle", f, f, 0.3, 0.2);
        });
        break;
      case "laser":
