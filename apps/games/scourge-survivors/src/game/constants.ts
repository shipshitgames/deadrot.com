...
export const WEAPONS: Record<WeaponId, WeaponSpec> = {
  pistol: {
    id: 'pistol', name: 'Pistol', damage: 26, fireInterval: 0.18, magazineSize: 15,
    reserve: 75, reserveCap: 225, pellets: 1, spread: 0.012, auto: false, ammoPerKill: 9,
    accent: 0xff6a00, barrelLen: 0.27, knockback: 2.8, shake: 0.045, kick: 0.014,
    adsFovs: [56], adsSpreadMul: 0.45, adsMoveMul: 0.82, dualCompatible: true,
  },
  smg: {
    ...
    accent: 0x9b5cff, barrelLen: 0.3, knockback: 2, shake: 0.03, kick: 0.007,
    adsFovs: [62], adsSpreadMul: 0.7, adsMoveMul: 0.86, dualCompatible: true,
  },
  shotgun: {
    ...
    accent: 0xffb02e, barrelLen: 0.5, knockback: 6, shake: 0.34, kick: 0.05,
    adsFovs: [66], adsSpreadMul: 0.82, adsMoveMul: 0.78, dualCompatible: true,
  },
  cannon: {
    ...
    accent: 0xff3b6b, barrelLen: 0.62, knockback: 14, shake: 0.6, kick: 0.09,
    adsFovs: [70], adsSpreadMul: 1, adsMoveMul: 0.62, dualCompatible: false,
  },
  sniper: {
    id: 'sniper', name: 'Sniper', damage: 92, fireInterval: 0.78, magazineSize: 5,
    reserve: 25, reserveCap: 60, pellets: 1, spread: 0.002, auto: false, ammoPerKill: 2,
    accent: 0xd7d2c4, barrelLen: 0.68, knockback: 8, shake: 0.22, kick: 0.06,
    adsFovs: [36, 18], adsSpreadMul: 0.18, adsMoveMul: 0.46, dualCompatible: true,
