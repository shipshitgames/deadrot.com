...
describe('asset manifest', () => {
  ...
  it('keeps pickup sprites low-resolution and nearest-filtered', () => {
    const pickupSpriteIds = ['pickup-health', 'pickup-ammo', 'pickup-damage', 'pickup-dual', 'pickup-xp-blood'] as const
  ...
  it('keeps current music and gun audio cues in the manifest', () => {
    ...
    expect(Object.keys(audio)).toEqual(expect.arrayContaining([
      'music-ash-reactor',
