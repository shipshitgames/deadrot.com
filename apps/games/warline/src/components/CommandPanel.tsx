    ...
    <section className="border-2 border-gunmetal bg-coal p-3">
      <div className="mb-2 flex items-center gap-1.5">
        ...
        <HelpTooltip label="Explain command panel" side="left">
          This is the open action panel. Pick the faction you are acting for,
          select a map region when needed, then spend shared resources to push
          the front back.
        </HelpTooltip>
      </div>
      ...
      <div className="mb-1 flex items-center gap-1.5">
        ...
        <HelpTooltip label="Explain acting faction" side="left">
          Pyre and Wardens are both Pact factions. This only decides who gets
          credited in the war feed when you issue commands.
        </HelpTooltip>
      </div>
      ...
      <div className="mb-3 border border-gunmetal bg-iron px-2 py-1.5">
        <span className="flex items-center gap-1 font-display text-[0.6rem] tracking-wide text-ash">
          ...
          <HelpTooltip label="Explain selected region" side="left">
            Most commands need a target. Click a node on the map to load its
            faction, pressure, and defense here.
          </HelpTooltip>
        </span>
        {selected ? (
