  ...
  return (
    <section className="border-2 border-gunmetal bg-coal p-3">
      <div className="mb-2 flex items-center gap-1.5">
        <h2 className="font-display text-xs tracking-wide text-ash">Legend</h2>
        <HelpTooltip label="Explain legend" side="left">
          The legend decodes map colors and overlays. Use it with the map tooltip cards to understand what is safe,
          contested, hidden, or actively dangerous.
        </HelpTooltip>
      </div>
      ...
      <div className="mt-2 flex flex-col gap-1 border-t border-gunmetal pt-2">
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip label="Explain active breach" side="left">
            A breach is a Scourge source. Active breaches raise pressure in their region every tick until operations
            damage or seal them.
          </HelpTooltip>
        </div>
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip label="Explain pressure heat ring" side="left">
            The ring fills as Scourge pressure rises. Human regions fall when pressure reaches 100.
          </HelpTooltip>
        </div>
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip label="Explain unrevealed sectors" side="left">
            Hidden sectors hide their real name and stats. Select the region and run Recon to reveal it.
          </HelpTooltip>
        </div>
      </div>
    </section>
