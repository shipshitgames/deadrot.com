...
lockedDate:
---
# Breach-Boss Design Lock

Games adapt from this file; runtime frames do not define the Breach-Boss.

## Canon Links

- Canon page: [[Breach-Boss]]
...
- Body materials: deep crimson-black flesh, black chitin, wet sinew.
- Accent materials: large cracked bone plates, rusted graft fragments.
- Emissive color: toxic green core and projectile organs, small hellfire rim.
- Forbidden colors: purple/magenta matte, cyan, clean neon, bright white grid
  artifacts.
...
- Scourge Survivors: FPS billboard boss, padded to avoid camera cropping.
- Deadlane: top-down siege boss with core readable from above.
- Rothulk: side-platformer breach-heart guardian.
