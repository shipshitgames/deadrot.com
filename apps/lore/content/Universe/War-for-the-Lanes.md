...
The current playable expression is [[Warline]]: a strategy-lite campaign layer with shared
resources, simple commands, and one operation contract per game. It is a prototype, not a
locked grand-strategy rulebook. Outcomes in Warline can move the test front without
...
3. If the campaign layer proves fun, deepen it into a real strategy game: better resource
   sinks, clearer faction decisions, more interesting operation targets, and slower front
   movement.
4. A **Dofus-like server** — persistent, instanced, isometric/tactical (see the
