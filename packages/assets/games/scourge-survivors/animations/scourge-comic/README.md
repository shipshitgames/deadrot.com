...
Status: opt-in runtime test pack, not production master output. It follows the
same frame counts, actions, and view names as the default `animations/scourge`
pack so the game can swap it without gameplay code changes.
